...
type IValue interface {
	...
	//
	// 返回值 Returns:
	//   - string: 转换后的字符串值 / Converted string value
	AsString() string
	...
	//
	// 返回值 Returns:
	//   - int: 转换后的整数值 / Converted integer value
	AsInt() int
	...
	//
	// 返回值 Returns:
	//   - int64: 转换后的64位整数值 / Converted 64-bit integer value
	AsInt64() int64
	...
	//
	// 返回值 Returns:
	//   - float64: 转换后的64位浮点数值 / Converted 64-bit float value
	AsFloat64() float64
	...
	//
	// 返回值 Returns:
	//   - bool: 转换后的布尔值 / Converted boolean value
	AsBool() bool
	...
	//
	// 返回值 Returns:
	//   - []byte: 转换后的字节数组 / Converted byte array
	AsBytes() []byte
	...
	//
	// 返回值 Returns:
	//   - time.Time: 转换后的时间值 / Converted time value
	AsTime() time.Time

	// AsObject 将值转换为对象，转换失败时返回nil
	// AsObject converts the value to object, returns nil on conversion failure
	//
	// 返回值 Returns:
	//   - IObject: 转换后的对象值 / Converted object value
	AsObject() IObject

	// AsArray 将值转换为数组，转换失败时返回nil
	// AsArray converts the value to array, returns nil on conversion failure
	//
	// 返回值 Returns:
	//   - IArray: 转换后的数组值 / Converted array value
	AsArray() IArray
}
